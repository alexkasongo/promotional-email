<h1 align="center">Responsive Promotional HTML Email.</h1>
...
- Responsive.
- Carousel with color picker.
- Dark Mode compatible 😍

## Screenshots

![alt text](https://portfolio-email-screenshots.s3.us-west-2.amazonaws.com/promotional-email.png)
